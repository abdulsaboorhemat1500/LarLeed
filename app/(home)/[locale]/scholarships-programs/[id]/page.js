          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                ...
                <div className="text-gray-700 dark:text-gray-300 leading-relaxed rich-text-content" dangerouslySetInnerHTML={{ __html: getLocalizedField(scholarship, 's_overview') }} />
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                ...
                <div className="text-gray-700 dark:text-gray-300 leading-relaxed rich-text-content" dangerouslySetInnerHTML={{ __html: getLocalizedField(scholarship, 's_detailed_info') }} />
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                ...
                <div className="text-gray-700 dark:text-gray-300 leading-relaxed rich-text-content" dangerouslySetInnerHTML={{ __html: getLocalizedField(scholarship, 's_eligibility') }} />
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                ...
                <div className="text-gray-700 dark:text-gray-300 leading-relaxed rich-text-content" dangerouslySetInnerHTML={{ __html: getLocalizedField(scholarship, 's_app_procces') }} />
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                ...
                <div className="text-gray-700 dark:text-gray-300 leading-relaxed rich-text-content" dangerouslySetInnerHTML={{ __html: getLocalizedField(scholarship, 's_benefits') }} />
              </div>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">{getLocalizedField(scholarship, 's_name')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">{getLocalizedField(scholarship, 's_country')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">{getLocalizedField(scholarship, 's_language')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">{getLocalizedField(scholarship, 's_gender') || 'Both Male & Female'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">{getLocalizedField(scholarship, 's_study_level')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">{getLocalizedField(scholarship, 's_duration')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">{getLocalizedField(scholarship, 's_funding_type')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{t('scholarshipDetailsPage.fields of study')}</p>
                      <p className="font-semibold text-gray-900 dark:text-white">
                        {getLocalizedField(scholarship, 's_fields_of_study') || 'Not specified'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{t('scholarshipDetailsPage.language required')}</p>
                      <p className="font-semibold text-gray-900 dark:text-white">
                        {getLocalizedField(scholarship, 's_language_required') || 'Not specified'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{t('scholarshipDetailsPage.eligible countries')}</p>
                      <p className="font-semibold text-gray-900 dark:text-white">
                        {getLocalizedField(scholarship, 's_eligible_countries') || 'All countries'}
                      </p>
                    </div>
                  </div>
                </div>
