              ...
              <div className="flex items-center gap-x-4">
                <div className="flex items-center gap-x-3">
                  ...
                  <h1 className="text-xl font-bold text-gray-900 dark:text-white">
                    Connecting Afghan Youth through Education, Dialogue, and
                    Vision
                  </h1>
                </div>
              </div>
                ...
                <div className="-my-6 divide-y divide-gray-500/10 dark:divide-gray-700">
                  <div className="space-y-2 py-6">
                    ...
                    <Link
                      href="/dashboard"
                      onClick={() => setMobileMenuOpen(false)}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 dark:text-white hover:bg-gray-50"
                    >
                      Dashboard
                    </Link>
                    <Link
                    ...
                    <Link
                      href="/scholarships-stu-video-cp"
                      onClick={() => setMobileMenuOpen(false)}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 dark:text-white hover:bg-gray-50"
                    >
                      Students Stories
