...
export default function AddScholarshipPage() {
 ...
 const renderMultiLanguageInput = (
   fieldBase,
   label,
   placeholder,
   isTextArea = false,
   ...
   const { value, disabled, customValue } = options;
   ...
   return (
     <div className="space-y-4">
       ...
       <div>
         ...
         {isRichText ? (
           <RichTextEditor
             value={customValue?.eng || formData[`${fieldBase}_eng`]}
             onChange={(value) =>
               handleRichTextChange(`${fieldBase}_eng`, value)
             }
       ...
       <div>
         ...
         {isRichText ? (
           <RichTextEditor
             value={customValue?.pash || formData[`${fieldBase}_pash`]}
             onChange={(value) =>
               handleRichTextChange(`${fieldBase}_pash`, value)
             }
       ...
       <div>
         ...
         {isRichText ? (
           <RichTextEditor
             value={customValue?.dari || formData[`${fieldBase}_dari`]}
             onChange={(value) =>
               handleRichTextChange(`${fieldBase}_dari`, value)
             }
             ...
             <div className="bg-gray-50 rounded-lg shadow-sm p-4">
               {renderMultiLanguageInput(
                 ...
                 false,
                 {
                   disabled: true,
                   customValue: {
                     eng: "Both Male and Female",
                     pash: "هم نارینه او هم ښځینه",
                     dari: "هم مرد و هم زن",
                   },
                 }
               )}
             ...
             <div className="bg-gray-50 rounded-lg shadow-sm p-4">
               {renderMultiLanguageInput(
                 ...
                 false,
                 {
                   disabled: true,
                   customValue: {
                     eng: "4 years (Full-time)",
                     pash: "۴ کاله (بشپړ وخت)",
                     dari: "۴ سال (تمام وقت)",
                   },
                 }
               )}
