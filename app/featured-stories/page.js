...
import SchoolCard from '@/components/articalCard';
...
export default function FeaturedStoriesList() {
  ...
  const allStories = [
    ...
    { id: 2, title: 'Introduction to Programming', description: 'kjdfkjdkfjdkjf d dkfj fd kjfddkjf ddf dkf dk d fdk fdkfjdk dkfjdkf df dk fdjf d ' },
    { id: 3, title: 'Introduction to Programming', description: 'kjdfkjdkfjdkjf d dkfj fd kjfddkjf ddf dkf dk d fdk fdkfjdk dkfjdkf df dk fdjf d ' },
    { id: 4, title: 'Introduction to Programming', description: 'kjdfkjdkfjdkjf d dkfj fd kjfddkjf ddf dkf dk d fdk fdkfjdk dkfjdkf df dk fdjf d ' },
    { id: 5, title: 'Introduction to Programming', description: 'kjdfkjdkfjdkjf d dkfj fd kjfddkjf ddf dkf dk d fdk fdkfjdk dkfjdkf df dk fdjf d ' },
