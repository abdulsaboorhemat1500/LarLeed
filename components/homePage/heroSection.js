      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-12 lg:py-0">
          ...
          <div className="flex-1 max-w-2xl lg:pr-12 text-center lg:text-left ">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-6 mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="text-gray-500 dark:text-gray-400">Teacthers</div>
              </div>
              <div className="text-center lg:text-left">
