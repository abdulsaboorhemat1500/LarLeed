...
export default function HeroSection() {
  ...
  if (loading) {
    return (
      <section className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 shadow-sm border-b flex items-center justify-center">
  ...
  return (
    <>
      <section className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-50 shadow-sm border-b">
